...
public class ProfileServiceImpl implements IProfileService {
	...
	public ProfileDetails fileUpload(ProfileDetails profileDetails)
		...
		ProfileDetails searchProfile = profileDetailsRepository.findByEmpId(profileDetails.getEmployeeId());
		if (searchProfile != null) {
			throw new Exception(
					"Resume already present for employeeId: " + profileDetails.getEmployeeId());
		} else {
	...
	public ProfileDetails updateProfile(ProfileDetails profileDetails) 
			...
			if (searchProfile != null) {
				...
				throw new ResourceNotFoundException("Profile details not present for employeeId: "+ searchProfile.getEmployeeId());
			}
