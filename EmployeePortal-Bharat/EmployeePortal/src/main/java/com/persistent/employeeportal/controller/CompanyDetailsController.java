...
public class CompanyDetailsController {
  ...
  //Get Particular Employee Company Details
	...
	public ResponseEntity<Object> getEmployeeCompanyDetails(@PathVariable("employeeId") Long employeeId) {
		try {
			CompanyDetails retrieveCompanyDetails = companyDetailsService.getCompanyDetailsById(employeeId);
