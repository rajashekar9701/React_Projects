...
public class ProfileUploadController {
	...
	public ResponseEntity<?> uploadToDatabase(@PathVariable String username, @RequestParam MultipartFile documentFile)
		...
		try {			
			...
			ProfileDetails profileDetails = setProfileDetails(getEmployeeId(username), documentFile);
	...
	public ResponseEntity<Resource> downloadFile(@PathVariable String username) throws FileNotFoundException, Exception {
		try {
			ProfileDetails profileDetails = iProfileService.downloadProfile(getEmployeeId(username));
	...
	public ResponseEntity<String> fileName(@PathVariable String username) throws FileNotFoundException, Exception {
		try {
			String fileName = iProfileService.getFileName(getEmployeeId(username));
	...
	private long getEmployeeId(String userName) throws IOException {
		
		return personalInformationRepository.findEmployeeIdByEmail(userName);
	}
