...
public class CompanyDetailsController {
    ...
    public ResponseEntity<Object> addCompanyDetails(@PathVariable("username") String username, @Valid @RequestBody CompanyDetails companyDetails)
    {
    	try {
    		CompanyDetails personalInformationResponse = companyDetailsService.createCompanyDetails(username, companyDetails);
