...
public class PersonalInformationControllerTest {
    ...
    public void testPostExample() throws Exception {
		...
		when(personalInformationService.createPersonalInfo(any(EmployeeDetails.class))).thenReturn(details);
		ResponseEntity<Object> responseEntity = personalInformationController.addPersonalInfo(details); 
